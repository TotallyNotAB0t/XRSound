# Documentation
This document explains rapidly how to use the project. It is composed of two scenes, one in usable in unity directly through the editor and the other one is to be used in AR.
